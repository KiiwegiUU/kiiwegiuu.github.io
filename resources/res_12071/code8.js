...
gdjs.levelFinishedScreenCode.asyncCallback15166556 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15166556(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15166100 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15166100(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15162244 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
{gdjs.evtTools.sound.playSound(runtimeScene, "sandExplosion.mp3", false, 100, 1);
}{gdjs.evtsExt__CameraShake__ShakeCamera.func(runtimeScene, 0.4, 0.2, 0.2, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
/* Don't save star7 as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15162244(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15160396 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
...
/* Don't save star7 as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15160396(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15161572 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
{gdjs.evtTools.sound.playSound(runtimeScene, "sandExplosion.mp3", false, 100, 1);
}{gdjs.evtsExt__CameraShake__ShakeCamera.func(runtimeScene, 0.4, 0.2, 0.2, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
/* Don't save star6 as it will be provided by the parent asyncObjectsList. */
/* Don't save star7 as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15161572(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15159940 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
...
/* Don't save star6 as it will be provided by the parent asyncObjectsList. */
/* Don't save star7 as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15159940(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.levelFinishedScreenCode.asyncCallback15155980 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.levelFinishedScreenCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.levelFinishedScreenCode.asyncCallback15155980(runtimeScene, asyncObjectsList)));
}
}
